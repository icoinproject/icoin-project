...
.. _`dependencies archive`: https://download.visucore.com/icoin/qtgui_deps_1.zip
.. [#] PGP signature: https://download.visucore.com/icoin/qtgui_deps_1.zip.sig (signed with RSA key ID `610945D0`_)
...
The static binary version of icoin is linked against libdb 5.0 (see also `this Debian issue`_).
