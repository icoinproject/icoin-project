...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "icoin is the next big thing";
        CTransaction txNew;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x111803901abdef3c01a5b38e8960a36fd3942973dd1a79d74862d63c84923bc2"));
        block.print();
